...
function runAway(e) {
    ...
    const texts = ['Pakro mujhe! ≡ƒÿ£', 'Haha! ≡ƒÅâΓÇìΓÖé∩╕Å', 'Too slow! ≡ƒÆ¿', 'Miss! ≡ƒÿé', 'Try again! ≡ƒñ¬', 'Nahi milonga! ≡ƒÿ¥'];
...
function createHeartExplosion() {
    const hearts = ['Γ¥ñ∩╕Å', '≡ƒÆò', '≡ƒÆû', '≡ƒÆù', '≡ƒÆ¥', '≡ƒÆô', '≡ƒÆ₧', '≡ƒî╣', '≡ƒÑ░', '≡ƒÿì'];
...
function createConfetti() {
    const colors = ['Γ¥ñ∩╕Å', '≡ƒÆò', '≡ƒÆû', 'Γ£¿', '≡ƒî╕', '≡ƒî║'];
...
window.addEventListener('load', () => {
    ...
    console.log('Website loaded! Show her this and she will forgive you! ≡ƒÆò');
});
...
document.addEventListener('dblclick', (e) => {
    if (e.target.tagName !== 'BUTTON') {
        ...
        if (doubleClickCount === 5) {
            alert('≡ƒî╣ You really love her, don\'t you? Go make her laugh and she\'ll forgive you! ≡ƒÆû');
            doubleClickCount = 0;
        }
    }
});
...
function setGreeting() {
    ...
    titleElement.textContent = 'I\'m Really Sorry! ≡ƒÑ║';
}
